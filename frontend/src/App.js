...
import logo2 from './fastMaticLogo.jpeg'
...
function App() {
  ...
  async function getNameAndBalance() {
    const res = await axios.get(`http://localhost:3003/getNameAndBalance`, {
    ...
    <div className="App">
      <Layout>
        <Header className="header">
          ...
          {isConnected ? (
            <Button type={'primary'} onClick={disconenctAndSetNull}>
              Disconnect Wallet
            </Button>
          ) : (
            <Button
        ...
        <Content className="content">
          {isConnected ? (
            ...
            <div>
              Please Login and send a request to get your initial investment
              back
            </div>
          )}
        </Content>
